...
- Reconhecimento automático de colunas e mapeamento manual
...
Abra o CRM e clique em **Importar planilha**. Arraste sua planilha. O sistema tentará localizar campos como Cliente, Data, Valor, Pedido, Cidade, UF, Vendedor, Produto e Status. Se algum campo não for reconhecido, selecione a coluna correta e clique em **Importar dados**.
